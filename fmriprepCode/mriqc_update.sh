...
dsroot=$HOME/Documents/Habituation_fMRI/deidentified # assume you are running from the root
codedir=$dsroot/code
...
docker run -it --rm -v $bidsroot:/data:ro -v $dsroot/derivatives/mriqc/sub-${sub}:/out \
poldracklab/mriqc:0.15.1 \
/data /out participant \
--participant_label $sub -w $dsroot/derivatives/mriqc/sub-${sub}
