...
for sub in "01" "03" "04" "05" "07" "08" "09" "10" "11"; do
#for sub in "02"; do
    ...
    TEMPLATE=${maindir}/templates/L2_task-sonet_model-01_hab.fsf
    ...
    -e 's@INPUT3@'$INPUT3'@g' \
    -e 's@INPUT4@'$INPUT4'@g' \
    <$TEMPLATE> ${MAINOUTPUT}/L2_task-sonet_model-01_hab.fsf
    feat ${MAINOUTPUT}/L2_task-sonet_model-01_hab.fsf
done
