...
# check for output and skip existing
	...
	# create template and run analyses
		...
		INPUT04=${EVDIR}/PunishC_Ques_${run}.txt
		INPUT05=${EVDIR}/PunishH_Ques_${run}.txt
		INPUT06=${EVDIR}/PunishF_Ques_${run}.txt
		INPUT07=${EVDIR}/RewardC_Ques_${run}.txt
		INPUT08=${EVDIR}/RewardH_Ques_${run}.txt
		INPUT09=${EVDIR}/RewardF_Ques_${run}.txt
